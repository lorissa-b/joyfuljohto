static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE28 - 1] = {MAP_GROUP(ROUTE28), MAP_NUM(ROUTE28), 10, 10},
    [HEAL_LOCATION_ROUTE29 - 1] = {MAP_GROUP(ROUTE29), MAP_NUM(ROUTE29), 10, 10},
    [HEAL_LOCATION_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 10, 10},
    [HEAL_LOCATION_ROUTE30 - 1] = {MAP_GROUP(ROUTE30), MAP_NUM(ROUTE30), 10, 10},
    [HEAL_LOCATION_ROUTE31 - 1] = {MAP_GROUP(ROUTE31), MAP_NUM(ROUTE31), 20, 10},
