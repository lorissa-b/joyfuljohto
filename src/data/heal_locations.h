static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 24, 10},
    [HEAL_LOCATION_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 41, 8},
    [HEAL_LOCATION_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 10, 10},
    [HEAL_LOCATION_NEW_BARK_TOWN_PLAYER_HOUSE_2F - 1] = {MAP_GROUP(NEW_BARK_TOWN_PLAYER_HOUSE_2F), MAP_NUM(NEW_BARK_TOWN_PLAYER_HOUSE_2F), 10, 10},
    [HEAL_LOCATION_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 14, 16},
};
